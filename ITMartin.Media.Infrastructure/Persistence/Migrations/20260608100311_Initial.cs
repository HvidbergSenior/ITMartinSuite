...
namespace ITMartin.Media.Infrastructure.Persistence.Migrations
{
    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "Package2Manifests",
                columns: table => new
                {
                    WorkflowId = table.Column<Guid>(type: "TEXT", nullable: false),
                    PackageId = table.Column<Guid>(type: "TEXT", nullable: false),
                    FileCount = table.Column<int>(type: "INTEGER", nullable: false),
                    EnhancementProfile = table.Column<string>(type: "TEXT", nullable: false),
                    RestorationProfile = table.Column<string>(type: "TEXT", nullable: false),
                    ItemsJson = table.Column<string>(type: "TEXT", nullable: false),
                    CreatedAtUtc = table.Column<DateTimeOffset>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Package2Manifests", x => x.WorkflowId);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WorkflowCheckpoints_CreatedAtUtc",
                table: "WorkflowCheckpoints",
                column: "CreatedAtUtc");

            migrationBuilder.CreateIndex(
                name: "IX_WorkflowCheckpoints_WorkflowId_IsLatest",
                table: "WorkflowCheckpoints",
                columns: new[] { "WorkflowId", "IsLatest" });

            migrationBuilder.CreateIndex(
                name: "IX_WorkflowCheckpoints_WorkflowId_StepName",
                table: "WorkflowCheckpoints",
