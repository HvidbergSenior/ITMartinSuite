...
public sealed class Package4Service : IPackage4Service
{
    ...
    // Danish/English pairs for every category folder Package1 can produce -
    ...
    private readonly ILogger<Package4Service> _logger;

    public Package4Service(IVideoMetadataService videoMetadataService, ICollectionStore collectionStore, ILogger<Package4Service> logger)
    {
