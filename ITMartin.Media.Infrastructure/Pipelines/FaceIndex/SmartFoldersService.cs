...
public sealed class SmartFoldersService : ISmartFoldersService
{
    ...
    private static readonly HashSet<string> SkippedFolders =
        new(StringComparer.OrdinalIgnoreCase)
        {
            ...
            // Same reasoning as FaceIndexService - motion-clip companions to
    ...
    private readonly IFaceIndexService _package3;
    ...
    // IsUnderUndatedFolder in FaceIndexService: this typically runs on a Windows
