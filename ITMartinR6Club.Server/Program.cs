using ITMartinR6Club.Server.Data;
using ITMartinR6Club.Server.Services;
...
{
    await push.UpsertSubscriptionAsync(db, new ITMartinR6Club.Server.Data.Entities.ClubPushSubscription
    {
        GroupId    = req.GroupId,
...
app.MapRazorComponents<ITMartinR6Club.Server.App>()
