...
public interface IFaceIndexService
{
    ...
    Task<FaceIndexIndexStatus?> GetIndexStatusAsync(string libraryPath, FaceIndexIndexType indexType);
    ...
    /// <summary>
    /// For videos sitting loose at Videoer root (no reliable date - QuickSort
    /// already tried EXIF/filename dating and came up empty), runs face
    /// detection directly on the video (reuses QuickSort's existing thumbnail
