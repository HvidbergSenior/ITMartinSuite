...
// Package4 - library health check. Actually tries to open/decode every file
...
public interface IPackage4Service
{
    ...
    /// to copy the library back locally or re-run Package1 (which isn't safe
